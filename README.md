...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-eomia4y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-eomia4y.containers.anotherwebservice.com/
...
```
git clone git@github.com:Deszcz68/container-eomia4y.git
cd container-eomia4y
```
...
```
docker attach container-eomia4y
```
